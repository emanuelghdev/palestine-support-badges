        ...
        <main className="flex flex-col-reverse md:grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <section className="col-span-2 space-y-4">
            ...
            <div className="flex gap-2 mb-10 flex-wrap">
              ...
              <button className="w-full sm:w-auto px-3 py-2 bg-rose-600 text-white rounded hover:bg-rose-700 cursor-pointer transition-all active:scale-90 disabled:opacity-50 disabled:cursor-not-allowed" onClick={() => handleCopy(`![Palestine Support Badge](${badgeUrl})`, "Markdown")}>{t('Copy Markdown')}</button>
              <button className="w-full sm:w-auto px-3 py-2 bg-emerald-700 text-white rounded hover:bg-emerald-800 cursor-pointer transition-all active:scale-90 disabled:opacity-50 disabled:cursor-not-allowed" onClick={() => handleCopy(`<img src=\"${badgeUrl}\" alt=\"Palestine Support Badge\" />`, "HTML")}>{t('Copy HTML')}</button>
