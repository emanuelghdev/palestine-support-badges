          ...
          <div className="flex w-full md:w-auto items-center justify-between md:justify-end gap-5">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <div className="flex gap-x-2 cursor-pointer">
                <a href="https://github.com/emanuelghdev/palestine-support-badges" target="_blank" rel="noopener noreferrer" role="link" className="flex items-center opacity-80 dark:opacity-85 transition-opacity hover:opacity-100" title={t('Go to the GitHub project')} aria-label={t('Go to the GitHub project')}>
              ...
              <div className="hidden md:flex gap-x-2 cursor-pointer">
                <a href="https://discord.com/channels/1186702814341234740/1413517051347337370" target="_blank" rel="noopener noreferrer" role="link" className="flex items-center opacity-80 dark:opacity-85 transition-opacity hover:opacity-100" title={t('Go to the Discord')} aria-label={t('Go to the Discord')}>
